...
let ProjectContent = class ProjectContent extends typeorm_1.BaseEntity {
};
__decorate([
...
], ProjectContent.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Date)
], ProjectContent.prototype, "modifiedAt", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], ProjectContent.prototype, "content", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)((type) => project_entity_1.Project, (project) => project.contents, { eager: false, onDelete: "CASCADE" }),
