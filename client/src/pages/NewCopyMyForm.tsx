            ...
            <section style={mainScreen}>
                ...
                <div style={inputsection}>
                    ...
                    <div style={inputBoxStyle}>
                        ...
                        <TextField id="outlined-basic" label="input email" variant="outlined" style={inputBoxStyle} type="text" name="name" value={name} onChange={onChange} required/>
                        <br/>
                        <TextField id="outlined-basic" label="input password" variant="outlined" style={inputBoxStyle} type="text" name="password" value={password} onChange={onChange} required/>
