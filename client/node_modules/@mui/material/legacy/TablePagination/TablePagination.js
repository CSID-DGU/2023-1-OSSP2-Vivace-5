...
var TablePaginationToolbar = styled(Toolbar, {
  ...
  slot: 'Toolbar',
  overridesResolver: function overridesResolver(props, styles) {
    return _objectSpread(_defineProperty({}, "& .".concat(tablePaginationClasses.actions), styles.actions), styles.toolbar);
  }
})(function (_ref2) {
  var _ref3;
...
var TablePaginationSelect = styled(Select, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var _objectSpread3;
    return _objectSpread(_objectSpread((_objectSpread3 = {}, _defineProperty(_objectSpread3, "& .".concat(tablePaginationClasses.selectIcon), styles.selectIcon), _defineProperty(_objectSpread3, "& .".concat(tablePaginationClasses.select), styles.select), _objectSpread3), styles.input), styles.selectRoot);
  }
})(_defineProperty({
  color: 'inherit',
  fontSize: 'inherit',
...
var TablePagination = /*#__PURE__*/React.forwardRef(function TablePagination(inProps, ref) {
  ...
  return /*#__PURE__*/_jsx(TablePaginationRoot, _objectSpread(_objectSpread({
    colSpan: colSpan,
    ref: ref,
    as: component,
    ...
    children: /*#__PURE__*/_jsxs(TablePaginationToolbar, {
      ...
      children: [/*#__PURE__*/_jsx(TablePaginationSpacer, {
      ...
      }), rowsPerPageOptions.length > 1 && /*#__PURE__*/_jsx(TablePaginationSelect, _objectSpread(_objectSpread(_objectSpread({
        variant: "standard"
      }, !SelectProps.variant && {
        ...
        children: rowsPerPageOptions.map(function (rowsPerPageOption) {
          return /*#__PURE__*/_createElement(MenuItemComponent, _objectSpread(_objectSpread({}, !isHostComponent(MenuItemComponent) && {
            ownerState: ownerState
          }), {}, {
