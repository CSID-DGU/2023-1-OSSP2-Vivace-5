...
export var FormLabelRoot = styled('label', {
  ...
  overridesResolver: function overridesResolver(_ref, styles) {
    ...
    return _objectSpread(_objectSpread(_objectSpread({}, styles.root), ownerState.color === 'secondary' && styles.colorSecondary), ownerState.filled && styles.filled);
  }
})(function (_ref2) {
  var _objectSpread2;
  ...
  }, theme.typography.body1), {}, (_objectSpread2 = {
    lineHeight: '1.4375em',
    padding: 0,
    position: 'relative'
  }, _defineProperty(_objectSpread2, "&.".concat(formLabelClasses.focused), {
    color: (theme.vars || theme).palette[ownerState.color].main
  }), _defineProperty(_objectSpread2, "&.".concat(formLabelClasses.disabled), {
    color: (theme.vars || theme).palette.text.disabled
  }), _defineProperty(_objectSpread2, "&.".concat(formLabelClasses.error), {
