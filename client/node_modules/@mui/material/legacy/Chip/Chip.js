...
var ChipRoot = styled('div', {
  ...
  return _objectSpread(_objectSpread(_objectSpread(_objectSpread((_objectSpread2 = {
    maxWidth: '100%',
  ...
  }, _defineProperty(_objectSpread2, "&.".concat(chipClasses.disabled), {
    opacity: (theme.vars || theme).palette.action.disabledOpacity,
    pointerEvents: 'none'
  }), _defineProperty(_objectSpread2, "& .".concat(chipClasses.avatar), {
    marginLeft: 5,
    marginRight: -6,
    width: 24,
    height: 24,
  ...
  }), _defineProperty(_objectSpread2, "& .".concat(chipClasses.avatarColorPrimary), {
    color: (theme.vars || theme).palette.primary.contrastText,
    backgroundColor: (theme.vars || theme).palette.primary.dark
  }), _defineProperty(_objectSpread2, "& .".concat(chipClasses.avatarColorSecondary), {
    color: (theme.vars || theme).palette.secondary.contrastText,
    backgroundColor: (theme.vars || theme).palette.secondary.dark
  }), _defineProperty(_objectSpread2, "& .".concat(chipClasses.avatarSmall), {
    marginLeft: 4,
    marginRight: -4,
    width: 18,
    height: 18,
    fontSize: theme.typography.pxToRem(10)
  }), _defineProperty(_objectSpread2, "& .".concat(chipClasses.icon), _objectSpread(_objectSpread({
    marginLeft: 5,
    marginRight: -6
    ...
    marginLeft: 4,
    marginRight: -4
  }), ownerState.iconColor === ownerState.color && _objectSpread({
    color: theme.vars ? theme.vars.palette.Chip.defaultIconColor : textColor
  }, ownerState.color !== 'default' && {
    color: 'inherit'
  }))), _defineProperty(_objectSpread2, "& .".concat(chipClasses.deleteIcon), _objectSpread(_objectSpread({
  ...
  return _objectSpread(_objectSpread({}, ownerState.clickable && (_ref15 = {
    userSelect: 'none',
    WebkitTapHighlightColor: 'transparent',
    cursor: 'pointer',
    '&:hover': {
  ...
  return _objectSpread(_objectSpread({}, ownerState.variant === 'outlined' && (_ref18 = {
...
var Chip = /*#__PURE__*/React.forwardRef(function Chip(inProps, ref) {
  ...
  var moreProps = component === ButtonBase ? _objectSpread({
