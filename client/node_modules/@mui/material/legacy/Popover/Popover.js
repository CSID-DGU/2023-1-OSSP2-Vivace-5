...
var Popover = /*#__PURE__*/React.forwardRef(function Popover(inProps, ref) {
  ...
  return /*#__PURE__*/_jsx(PopoverRoot, _objectSpread(_objectSpread({
    BackdropProps: {
      invisible: true
    },
    ...
    children: /*#__PURE__*/_jsx(TransitionComponent, _objectSpread(_objectSpread({
      ...
      children: /*#__PURE__*/_jsx(PopoverPaper, _objectSpread(_objectSpread(_objectSpread({
        elevation: elevation
      }, PaperProps), {}, {
        ref: handlePaperRef,
        className: clsx(classes.paper, PaperProps.className)
      }, isPositioned ? undefined : {
        style: _objectSpread(_objectSpread({}, PaperProps.style), {}, {
          opacity: 0
        })
      }), {}, {
        ownerState: ownerState,
