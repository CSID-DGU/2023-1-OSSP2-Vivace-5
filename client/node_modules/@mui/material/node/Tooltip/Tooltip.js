...
const Tooltip = /*#__PURE__*/React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const popperProps = (0, _base.appendOwnerState)(PopperComponent, {
    ...PopperProps,
  ...
  const transitionProps = (0, _base.appendOwnerState)(TransitionComponent, {
    ...TransitionProps,
    ...((_slotProps$transition = slotProps.transition) != null ? _slotProps$transition : componentsProps.transition)
  }, ownerState);
  const tooltipProps = (0, _base.appendOwnerState)(TooltipComponent, {
  ...
  const tooltipArrowProps = (0, _base.appendOwnerState)(ArrowComponent, {
